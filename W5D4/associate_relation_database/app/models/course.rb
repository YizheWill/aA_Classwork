...
class Course < ApplicationRecord
  ...
  #     end
  #   end
  belongs_to :prerequisite, primary_key: :id, foreign_key: :prereq_id, class_name: :Course
  has_one :future_class, primary_key: :id, foreign_key: :prereq_id, class_name: :Course
